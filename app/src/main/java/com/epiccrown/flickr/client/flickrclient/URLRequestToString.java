...
public class URLRequestToString {
    ...
    private static final Uri ENDPOINT = Uri
            ...
            .buildUpon()
            .appendQueryParameter("api_key",GalleryFragment.API_KEY)
...
//            Log.i("JSON RECEIVED",jsonString);
//            return items;
//        }catch (Exception ex){ex.printStackTrace(); Log.e("FAILED FETCHING","FAILED TO FETCH ITEMS");}
//        return null;
//    }
